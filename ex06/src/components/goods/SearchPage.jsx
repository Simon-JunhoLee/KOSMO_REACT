        ...
        setBox({
            ...
            action: () => {
                ...
                goods.forEach(async good => {
                    if (good.checked) {
                        const res = await axios.post('/goods/insert', {
                            gid: good.productId, title: removeTags(good.title),
            ...
            <Row>
                <Col>
                    <input checked={goods.length === checked}
                        type="checkbox" className='form-check-input mx-2' onChange={onChangeAll} />
                ...
                <tbody>
                    {goods.map(good =>
                        <tr key={good.productId}>
                            <td><input onChange={(e) => onChangeSingle(e, good.productId)} className='form-check-input'
