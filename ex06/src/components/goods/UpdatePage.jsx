...
const UpdatePage = () => {
    ...
    return (
        <div>
                ...
                <Card.Body>
                    <Row className='justify-content-center'>
                        <Col md={4} lg={3} className='mb-3'>
                            ...
                            <div>
                                <Button onClick={onClickImageSave} className='w-100 mt-2' variant='dark'>이미지저장</Button>
                            </div>
                        </Col>
                        <Col className='mt-3'>
                            ...
                            <div className='text-center my-3'>
                                <Button onClick={onClickUpdate}
                                    className='me-2' variant='dark'>정보수정</Button>
            ...
            <Detail form={form} setForm={setForm} gid={gid} callAPI={callAPI} good={good}/>
        </div>
    )
}
